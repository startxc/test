...
<div class="header">
    <span class="action_title"> <a href="__URL__">分类管理</a></span> <span class="action_module"> - 分类列表 </span>
        ...
        <div class="list_div">
            <table class="list_table" cellspacing="1" cellpadding="3">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="list_tr">
                        ...
                        <td class="td_center_show"> <a href="javascript:void();"> <?php if($vo['is_show'] == 1): ?><img border="0" src="__ROOT__/Public/Images/yes.gif"> <?php else: ?> <img border="0"  src="__ROOT__/Public/Images/no.gif"><?php endif; ?> </a> </td>
                        <td class="td_center_show"> 
                            <span class="control_span">   
                                <a href="__URL__/edit/id/<?php echo ($vo["id"]); ?>" title="编辑分类"><img border="0" src="__ROOT__/Public/Images/icon_edit.gif"/></a>
                                <a href="javascript:deletes(<?php echo ($vo["id"]); ?>);" title="删除该分类"><img border="0" src="__ROOT__/Public/Images/icon_drop.gif"/></a>
                            </span>
                        </td>
