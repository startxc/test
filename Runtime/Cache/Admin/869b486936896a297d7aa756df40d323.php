...
<div class="header"> <span class="action_title"> <a href="#">添加会员</a></span> <span class="action_module"> - 添加基本信息 </span> <span class="action_span" > <a href="__URL__">会员列表</a> </span>
  <div class="clear"> </div>
</div>
<div id="middle"> 
  <!--列表-->
  <form method="post" id="addform">
	    ...
	    <table class="add_table" cellspacing="1" cellpadding="3"  style="padding: 10px 0;">
	      <tr>
	        ...
	        <td><div class="box_other_item">
	            <ul>
	              <li style="width:60px;"> <input class="checkbox" type="radio" value="normal" checked="checked" name="info[member_type]" 
	                <label class="label_name" style="width:30px;">普通用户</label>
	              </li>
	              <li style="width:70px;"> <input class="checkbox" type="radio" value="saleman" name="info[member_type]" 
	      ...
	      <tr>
	        ...
	        <td ><input id="nickname" type="text" class="add_input_text" name="info[nickname]"></td>	        
	      </tr>
	      <tr>
	        <td width="100" align="center">绑定手机</td>
	        <td><input id="mobile" type="text" name="info[mobile]"  class="add_input_text"/></td>
	        <td width="100" align="center">绑定会员卡号</td>
	        <td><input type="text" name="info[bind_member]" class="add_input_text"/></td>
	      </tr>
	      <tr>
			<tr>
	        <td width="100" align="center">详细地址</td>
	        <td colspan="3"><select name="info[province_id]" id="province" class="select" title="省">
	            <option value="" >-请选择-</option>
	          </select>
	          <select name="info[city_id]" id="city" class="select" title="市">
	            <option value="" >-请选择-</option>
	          </select>
	          <select name="info[area_id]" id="area" class="select" title="区(县)">
	            <option value="" >-请选择-</option>
	          </select>
	          <select name="info[community_id]" id="community" class="select" title="社区">
	            <option value="" >-请选择-</option>
	          </select>
	          <input id="address" type="text" name="info[address]"   class="add_input_text"/></td>
	      </tr>
	    </table>
	  </div>
	  ...
	  <div class="list_div" style="border:none;">
	      <table class="submit_table">
	        <tr>
	          <td><span>
	            <input id="js_add_member" type="submit" value="提交保存" />
	            </span></td>
	        </tr>
	      </table>
		</div>
