...
<div class="header">
    <span class="action_title"> <a href="__URL__">权限管理</a></span> <span class="action_module"> - <?php if($level == 1): ?>应用列表<?php endif; ?> <?php if($level == 2): ?>模块列表<?php endif; ?> <?php if($level == 3): ?>操作列表<?php endif; ?>  </span>
    
    <span class="action_span" > 
        <?php if($level == 1): ?><a href="__URL__/add/level/<?php echo ($level); ?>">添加应用</a><?php endif; ?> 
        <?php if($level == 2): ?><a href="__URL__/add/level/<?php echo ($level); ?>">添加模块</a><?php endif; ?> 
        <?php if($level == 3): ?><a href="__URL__/add/level/<?php echo ($level); ?>">添加操作</a><?php endif; ?> 
    </span>
    <div class="clear"> </div>
</div>
    ...
    <div class="list_div">
        <table class="list_table" cellspacing="1" cellpadding="3">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="list_tr">
                    ...
                    <td> <a href="__URL__/index/pid/<?php echo ($vo["id"]); ?>" title="模块列表"><?php echo ($vo["title"]); ?></a> </td>
                    <td> <a href="__URL__/index/pid/<?php echo ($vo["id"]); ?>" title="模块列表"><?php echo ($vo["name"]); ?></a> </td>
                    <td> 
                        <?php if(array_key_exists($vo['group_id'], $groupList)) { echo $groupList[$vo['group_id']]; } else { echo "未分组"; } ?>
                    </td>
                    ...
                    <td class="td_center_show"> 
                        ...
                        <?php if($level < 3): ?><a href="__URL__/index/pid/<?php echo ($vo["id"]); ?>" title="模块列表"><img border="0" src="__ROOT__/Public/Images/icon_view.gif"/></a><?php endif; ?>
                        <a href="__URL__/edit/id/<?php echo ($vo["id"]); ?>" title="编辑应用"><img border="0" src="__ROOT__/Public/Images/icon_edit.gif"/></a>
                        <a href="javascript:deletes(<?php echo ($vo["id"]); ?>);" title="删除该应用"><img border="0" src="__ROOT__/Public/Images/icon_drop.gif"/></a>
                        </span>
                    </td>
