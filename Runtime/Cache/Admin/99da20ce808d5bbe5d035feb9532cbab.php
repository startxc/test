        ...
        <div class="list_div">
            <table class="add_table" cellspacing="1" cellpadding="3"  style="padding: 10px 0;">
                ...
                <tr>
                    ...
                    <td> <input type="radio" name="status" value="1" checked />启用&nbsp;&nbsp;<input type="radio" name="status" value="0" />禁用</td>
                </tr>
            </table>
           ...
           //商品图片
            ...
            if(isSubmitButton === false){
                ...
                $.ajax({
                    type:"post",
                    url:"__URL__/insert",
                    data:{cid:cid,pid:pid,name:name,price:price,spec:spec,images:images,desc:desc,order:order,status:status},
                    async:false,
