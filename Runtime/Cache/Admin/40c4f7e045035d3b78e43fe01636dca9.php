        ...
        <div class="list_div">
            <table class="list_table" cellspacing="1" cellpadding="3">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="list_tr">
                        ...
                        <td class="td_center_show"> <?php if($vo['status'] == 1): ?><img border="0" src="__ROOT__/Public/Images/yes.gif"> <?php else: ?> <img border="0"  src="__ROOT__/Public/Images/no.gif"><?php endif; ?>  </td>
                        <td class="td_center_show"> 
                            <span class="control_span">
                                <a href="javascript:reverts(<?php echo ($vo["id"]); ?>);" title="还原商品"> 还原 </a>
                            </span>
                        </td>
