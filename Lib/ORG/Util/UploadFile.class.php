...
class UploadFile {//类定义开始
    ...
    private function getSaveName($filename) {
        ...
        return ($this->imagePrefix . $saveName); //changed by kewen
    }
     ...
     * @return string
      +----------------------------------------------------------
     */
    public static function createPath($prefix) {
        $dir0 = str_replace(APP_NAME."/", "upload/{$prefix}/", ROOT_PATH);
        $dir1 = $dir0 . date("Ym") . "/";
        $dir2 = $dir1 . date("d") . "/";
     ...
     * @return string
      +----------------------------------------------------------
     */
    public static function getPicturePath($prefix, $pic) {
        $dir0 = str_replace(APP_NAME."/", "upload/{$prefix}/", ROOT_PATH);
        $dir1 = substr($pic, 0, 6);
        $dir2 = substr($pic, 6, 2);
        return $dir0 . $dir1 . '/' . $dir2 . '/' . $pic;
    }
