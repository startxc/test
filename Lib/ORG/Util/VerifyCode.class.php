...
class VerifyCode {
    ...
    * @return string
    +----------------------------------------------------------
    */
    static function buildImageVerify( $length=5, $mode='', $type='png', $width=300, $height=100, $size=40, $verifyName='verifyCode') {

        import('@.ORG.Util.String');
        $fontPath = ROOT_PATH."Public/Font/elephant.ttf";
